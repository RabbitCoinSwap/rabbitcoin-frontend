...
import { BLOCKS_PER_YEAR, RABBIT_PER_YEAR_FARM, RABBIT_PER_YEAR_NFTFARM } from 'config'
...
export const getFarmApr = (
  ...
  const yearlyCakeRewardAllocation = poolWeight ? poolWeight.times(RABBIT_PER_YEAR_FARM) : new BigNumber(NaN)
