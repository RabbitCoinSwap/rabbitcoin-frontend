...
import rabbitCoinPool from 'config/abi/rabbitCoinPool.json'
import rabbitCoinFarm from 'config/abi/rabbitCoinFarm.json'
import rabbitCoinNftStake from 'config/abi/rabbitCoinNftStake.json'
import smartNftStake from 'config/abi/smartNftStake.json'
import rabbitCoinClaimReward from 'config/abi/rabbitCoinClaimReward.json'
...
import { RabbitCoinAutoPoolVault } from 'config/abi/types/RabbitCoinAutoPoolVault'
...
export const getRabbitCoinNFTContract = (address: string, signer?: Signer | Provider) => {
  return getContract(rabbitCoinNftAbi, address, signer) as RabbitCoinNft
}
...
// -----
export const getRabbitCoinContract = (signer?: Signer | Provider) => {
  return getContractForPolygon(cakeAbi, tokens.rabbit.address, signer) as Cake
}
...
export const getRabbitCoinPoolContract = (signer?: Signer | Provider) => {
  return getContractForPolygon(rabbitCoinPool, getRabbitCoinPoolAddress(), signer) as RabbitCoinPool
}
// Only Farm Version Masterchef
export const getRabbitCoinFarmContract = (signer?: Signer | Provider) => {
  return getContractForPolygon(rabbitCoinFarm, getRabbitCoinFarmAddress(), signer) as RabbitCoinFarm
}
// NFT Stake Version Masterchef
export const getRabbitCoinNftStakeContract = (signer?: Signer | Provider) => {
