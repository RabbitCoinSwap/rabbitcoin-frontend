...
const claims: any[] = [
  {
    ...
    description: <Trans>RabbitCoin NFT holders, your share of the reward pool awaits! Step into the realm of exclusive benefits and claim your deserving share. RabbitCoin - where ownership translates into rewards!</Trans>,
  ...
  },
  {
    ...
    description: <Trans>LotShare and RabbitCoin NFT holders can now claim their LOT tokens, a gift to our vibrant community. At LotShare, ownership equates to rewards, offering exclusive benefits within our ecosystem.</Trans>,
  ...
  },
  {
    cid: 1,
    name: 'Blitz Rewards',
    description: <Trans>BRAWLER and RabbitCoin NFT holder? Your share of BLITZ tokens awaits you as a special gift from us. At BlitzBrawler, we turn ownership into rewards, tournaments, contests, games, and endless fun.</Trans>,
  ...
  },
  {
    cid: 2,
    name: 'Avatar Rewards',
    description: <Trans>Do you own an Avatar NFT or a RabbitCoin NFT? As a special thank you from our team, exclusive AVATAR tokens have been reserved just for you.</Trans>,
  ...
  },
  {
    ...
    description: <Trans>The RabbitCoin Galxe Claim Pool is now open to all OAT NFT holders! Be among the first 10,000 to hit the claim button, and you'll be eligible to claim exclusive rewards.</Trans>,
  ...
  },
  {
    cid: 4,
    name: 'Hunter Rewards',
    description: <Trans>Do you own an BeastHunter NFT or a RabbitCoin NFT? As a special thank you from our team, exclusive HUNT tokens have been reserved just for you.</Trans>,
  ...
  },
  {
    cid: 5,
    name: 'Key Rewards',
    description: <Trans>Unlock the world of web3 with the KEY. Mint your Key NFT on OpenSea, then claim exclusive rewards on RabbitCoin. Join and open doors to the metaverse and beyond!</Trans>,
  ...
  },
  {
    cid: 6,
    name: 'Nitro Rewards',
    description: <Trans>Are you a holder of a CAR NFT or a RabbitCoin NFT? In appreciation for your support, our team has exclusively reserved NITRO tokens for you.</Trans>,
  ...
  },
  {
    ...
    description: <Trans>Do you own a PLACEDJ NFT or a RabbitCoin NFT? As a token of our gratitude for your support, our team has set aside DJ tokens exclusively for you.</Trans>,
  ...
  },
  {
    cid: 8,
    name: 'Tasker Rewards',
    description: <Trans>The RabbitCoin Tasker Claim Pool is now open to all TASKER NFT holders! Be among the first 10,000 to hit the claim button, and you'll be eligible to claim exclusive rewards.</Trans>,
  ...
  },
  {
    ...
    description: <Trans>If you own a GENTLEMAL NFT or a RabbitCoin NFT, as a gesture of our appreciation for your support, our team has reserved $Z tokens exclusively for you.</Trans>,
