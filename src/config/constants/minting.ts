...
import { getRabbitCoinBronzeNftAddress, getRabbitCoinGoldNftAddress, getRabbitCoinNftAddress, getRabbitCoinSilverNftAddress, getLotNftAddress, getBlitzBrawlerNftAddress, getAvatarsAiNftAddress, getBeastHunterNftAddress, getNitroNftAddress, getPlaceDjNftAddress, getZidanogoNftAddress } from 'utils/addressHelpers'
...
const ifos: Minting[] = [
  //============================Free Mint NFTS====================================
  {
    ...
    description: 'RabbitCoin Starter NFTs are most valuable FREE utility NFTs on the market. Starter NFT is a gift and a lifetime privilege to our community. Starter NFTs earn new tokens from pools and airdrops. it also has a chance on whitelists',
    ...
    faq: [
      {
        ...
        description: ["RabbitCoin provides four distinct categories of NFTs, namely Starter, Bronze, Silver, and Gold. The Starter NFT is a free offering intended for community development and surprisingly includes all advantages seen in the other types. The Gold NFT is considered the most prestigious and valuable among the available categories."]
      },
      {
        title: "What benefits do I get from RabbitCoin NFTs?",
        description: ["Owning a RabbitCoin NFT carries a slew of perks. These include the ability to stake your NFTs in any active pool on RabbitCoin to accumulate new tokens. You'll also gain access to all pools on the claim page, secure discounts across various collections, be whitelisted for upcoming projects, participate in exclusive minting events, and obtain a special Discord role in our owned communities. The platform is also continually working on launching more exciting benefits."]
      },
      {
        title: "How can I get these NFTs?",
        description: ["For acquiring a Starter NFT, you need to check secondary marketplaces like OpenSea. However, the Bronze, Silver, and Gold NFTs can be directly minted on RabbitCoin. With every sale, the pricing elevates, naturally causing an increase in the floor price."]
      },
      {
        title: "Can I use RabbitCoin NFTs on other platforms?",
        description: ["Yes, you certainly can. RabbitCoin NFTs are built on the Polygon blockchain and are thus compatible with any other marketplaces that support Polygon, such as OpenSea."]
      },
      {
  ...
  //============================Bronze NFTS====================================
  {
    ...
    description: 'RabbitCoin Bronze NFTs are the cheapest valuable utility NFTs that has all the features of Starter NFTs also 5x more powerful than Starter NFTs. Bronze NFTs earn more than Starter NFTs from pools and airdrops. it also has more chance on whitelists',
  ...
  //============================Silver NFTS====================================
  {
    ...
    description: 'RabbitCoin Silver NFTs are the medium powerful utility NFTs that has all the features of Bronze NFTs also 15x more powerful than Starter NFTs. Silver NFTs earn more than Bronze NFTs from pools and airdrops. it also has more chance on whitelists',
  ...
  //============================Gold NFTS====================================
  {
    ...
    description: 'RabbitCoin Gold NFTs are the most valuable utility NFTs that has all the features of Starter NFTs also 45x more powerful than Starter NFTs. Gold NFTs earn more than Silver NFTs from pools and airdrops. it also has more chance on whitelists',
  ...
  //============================LOT NFTS====================================
  {
    ...
    showCase: [
      { 'tokenId': 57, 'image': 'https://rabbitcoin.xyz/assets/images/showcase/lotNFT_20.png', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 245, 'image': 'https://rabbitcoin.xyz/assets/images/showcase/lotNFT_21.png', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 454, 'image': 'https://rabbitcoin.xyz/assets/images/showcase/lotNFT_22.png', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 679, 'image': 'https://rabbitcoin.xyz/assets/images/showcase/lotNFT_23.png', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
    ],
    faq: [
      {
  ...
  //============================BlitzBrawler NFTS====================================
  {
    ...
    showCase: [
      { 'tokenId': 8, 'image': 'https://i.seadn.io/gcs/files/d123afa62c649e05eef7778901f41844.png?auto=format&dpr=1&w=1000', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 134, 'image': 'https://i.seadn.io/gcs/files/d7ddf6e4d08cb15cf9d18ef9278d5b00.png?auto=format&dpr=1&w=1000', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 201, 'image': 'https://i.seadn.io/gcs/files/8df761db003534772e5c1ca088d9729e.png?auto=format&dpr=1&w=1000', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
      { 'tokenId': 94, 'image': 'https://i.seadn.io/gcs/files/5db953c72fedd2df4fea7ec4dd000f38.png?auto=format&dpr=1&w=1000', 'link': 'https://opensea.io/collection/rabbitcoin-gold-nft' },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        description: ["You can purchase already minted Brawlers on OpenSea or mint a fresh Brawler exclusively from RabbitCoin at a more affordable rate and with exclusive benefits. Details are available on our official website."]
      },
      {
      ...
      },
      {
        ...
        description: ["BLITZ tokens can be purchased on RabbitCoin and UniSwap. For more information on acquiring BLITZ tokens, visit blitzbrawler.com."]
      },
      {
  ...
  //============================AvatarsAI NFTS====================================
  {
    ...
    faq: [
      ...
      },
      {
        ...
        description: ["You can buy and sell AVATAR tokens via RabbitCoin or Uniswap. Detailed information on obtaining the tokens is available on our official website."]
      },
      {
        title: "Can I stake or farm AVATAR tokens?",
        description: ["Yes, you can stake and farm the AVATAR token on RabbitCoin. For more information on staking and farming options, please visit our official website or RabbitCoin's platform."]
      },
      {
  ...
  //============================Nitro NFTS====================================
  {
    ...
    faq: [
      ...
      },
      {
        ...
        description: ["Begin your NitroClash journey by minting or purchasing a unique car NFT. You can mint a fresh car using RabbitCoin, buy one from platforms like OpenSea, or even stake your car at RabbitCoin to start earning $NITRO tokens."]
      },
      {
      ...
      },
      {
        ...
        description: ["To acquire NitroClash car NFTs, you can mint new cars from RabbitCoin or buy them from NFT marketplaces such as OpenSea, Element Market, and others. The choice is yours!"]
      }
    ],
