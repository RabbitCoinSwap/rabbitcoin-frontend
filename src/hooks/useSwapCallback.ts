...
import { SwapParameters, Trade } from '@rabbitcoin/sdk'
...
function swapErrorToUserReadableMessage(error: any, t: TranslateFunction) {
  ...
  switch (reason) {
    ...
    case 'RabbitCoinRouter: INSUFFICIENT_OUTPUT_AMOUNT':
    case 'RabbitCoinRouter: EXCESSIVE_INPUT_AMOUNT':
      return t(
