              ...
              <CardBody>
                ...
                {account && (
                  <Flex alignItems="center" mb="8px">
                    ...
                    <LinkExternal href={getPolygonScanLink(account, 'address')}>{truncateHash(account)}</LinkExternal>
                  </Flex>
                )}
                <Flex alignItems="center" mb="16px">
                  ...
                  <LinkExternal href={getPolygonScanLink(snapshot, 'block')}>{snapshot}</LinkExternal>
                </Flex>
                {account ? (
                  <>
                    <Button
