...
import { useRabbitCoinAutoPoolVaultContract } from 'hooks/useContract'
...
const BountyModal: React.FC<BountyModalProps> = ({
  ...
  const cakeVaultContract = useRabbitCoinAutoPoolVaultContract()
    ...
    <Modal title={t('Claim Bounty')} onDismiss={onDismiss} headerBackground={theme.colors.gradients.cardHeader}>
      ...
      <Flex alignItems="flex-start" justifyContent="space-between">
        ...
        <Flex flexDirection="column">
          <Balance bold value={cakeBountyToDisplay} decimals={7} unit=" RABBIT" />
      ...
      <Flex alignItems="center" justifyContent="space-between">
        ...
        <Balance color="textSubtle" value={totalYieldToDisplay} unit=" RABBIT" />
      </Flex>
