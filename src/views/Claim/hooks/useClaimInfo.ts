...
import { useRabbitCoinClaimRewardContract, useRabbitCoinClaimRewardV2Contract } from 'hooks/useContract'
import claimConfig from 'config/constants/claim'
import nftFarmsConfig from 'config/constants/nftFarms'
import BigNumber from 'bignumber.js'
import { getAddress, getRabbitCoinClaimRewardV2Address } from 'utils/addressHelpers'
import { multicallPolygonv2 } from 'utils/multicall'
import rabbitCoinClaimRewardAbi from 'config/abi/rabbitCoinClaimReward.json'
