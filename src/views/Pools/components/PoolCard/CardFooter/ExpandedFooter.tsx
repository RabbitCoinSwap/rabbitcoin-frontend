    ...
    <ExpandedWrapper flexDirection="column">
...

      {
        <Flex mb="2px" justifyContent="flex-end">
          <LinkExternal href={`https://rabbitcoin.xyz/info/token/${earningToken.address}`} bold={false} small>
            {t('See Token Info')}
          </LinkExternal>
        </Flex>
      }
      ...
      {poolContractAddress && (
        <Flex mb="2px" justifyContent="flex-end">
          <LinkExternal
            href={`${BASE_POLYGON_SCAN_URL}/address/${vaultKey ? cakeVaultContractAddress : poolContractAddress}`}
            bold={false}
            small
          >
            {t('View Contract')}
