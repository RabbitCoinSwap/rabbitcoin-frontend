...
export const getDisplayApr = (cakeRewardsApr?: number) => {
  if (cakeRewardsApr) {
    return cakeRewardsApr.toLocaleString('en-US', { maximumFractionDigits: 4 })
  }
  return null
}
...
const Farms: React.FC = ({ children }) => {
  ...
  const rowData = chosenFarmsMemoized.map((farm) => {
    const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('RABBITCOIN', '')
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      ...
      <Page>
        ...
        <div ref={observerRef} />
        <StyledImage src="/images/decorations/3dpan.png" alt="Pancake illustration" width={192} height={184.5} />
      </Page>
