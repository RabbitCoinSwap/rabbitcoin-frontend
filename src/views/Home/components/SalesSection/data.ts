...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  reverse: false,
  primaryButton: {
    to: '/swap?outputCurrency=0x28767E286113Ab01EE819b9398A22D6f27BaDb6E',
    text: t('Buy Now'),
    external: false,
  },
  secondaryButton: {
  ...
  images: {
    ...
    attributes: [
      { src: 'bottom-right', alt: t('RABBIT angry birds') },
      // { src: 'top-right', alt: t('RABBIT Simpsons') },
      // { src: 'coin', alt: t('RABBIT Vader') },
      // { src: 'top-left', alt: t('RABBIT minions') },
    ],
  },
})
