...
import { getRabbitCoinPoolAddress } from 'utils/addressHelpers'
...
const emissionsPerBlock = 1.33
const rabbitPoolAddress = getRabbitCoinPoolAddress()
...
const CakeDataRow = () => {
  ...
  useSlowRefreshEffect(() => {
    const fetchTokenData = async () => {
      const totalSupplyCall = { address: tokens.rabbit.address, name: 'totalSupply' }
      const burnedTokenCall = {
        address: tokens.rabbit.address,
        name: 'balanceOf',
