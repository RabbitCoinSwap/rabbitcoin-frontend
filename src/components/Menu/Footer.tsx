    ...
    <Wrapper $isSide={isSide}>
      <Flex flexDirection={isSide ? 'column' : ['column', 'column', 'row']} alignItems="center">
        {/*<ButtonMenu variant="subtle" scale="sm" activeIndex={0}>
          ...
          <ButtonMenuItem as="a" href="https://docs.rabbitcoin.xyz">
            {t('V1 (old)')}
          </ButtonMenuItem>
        </ButtonMenu>
        <LinkExternal
      ...
      >
        <BubbleWrapper>
          <Button id="clickExchangeHelp" as="a" external href="https://docs.rabbitcoin.xyz/help/get-started" variant="subtle">
            {t('Need help ?')}
          </Button>
