...
import rabbitCoinNftStakeABI from 'config/abi/rabbitCoinNftStake.json'
...
import { getAddress, getRabbitCoinNftStakeAddress } from '../../utils/addressHelpers'
import { getRabbitCoinNftStakeContract } from '../../utils/contractHelpers'
import smartNftStakeABI from '../../config/abi/smartNftStake.json'

const masterChefAddress = getRabbitCoinNftStakeAddress() //getMasterChefAddress()
const masterChefContract = getRabbitCoinNftStakeContract() //getMasterchefContract
