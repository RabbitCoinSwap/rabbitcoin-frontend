...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, rabbitCoinDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | rabbitCoinDayData): ChartEntry => ({
